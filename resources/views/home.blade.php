                    ...
                    <div class="tiny-slider arrow-hover arrow-blur arrow-round position-relative">
                        <div class="tns-outer" id="tns1-ow">
                            <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide
                                <span class="current">2</span> of 3</div>
                            <div id="tns1-mw" class="tns-ovh">
                                <div class="tns-inner" id="tns1-iw">
                                    <div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                        data-autoplay="false" data-hoverpause="true" data-gutter="2" data-arrow="false"
                                        data-dots="true" data-items="1" id="tns1"
                                        style="transition-duration: 0s; transform: translate3d(-20%, 0px, 0px);">
                                        <div class="card bg-dark-overlay-3 rounded-0 h-400 h-lg-500 h-xl-700 position-relative overflow-hidden tns-item tns-slide-cloned"
                                            style="background-image:url(assets/images/blog/16by9/big/03.jpg); background-position: center left; background-size: cover;"
                                            ...
                                            <div class="card-img-overlay rounded-0 d-flex align-items-center">
                                                <div class="container w-100 my-auto">
                                                    <div class="row">
                                                        <div class="col-lg-7">
                                                            <!-- Card category -->
                                                            <a href="https://blogzine.webestica.com/index-2.html#"
                                                                class="badge bg-primary mb-2"><i
                                                                    class="fas fa-circle me-2 small fw-bold"></i>Covid-19</a>
                                                            <!-- Card title -->
                                                            <h2 class="text-white display-5"><a
                                                                    href="https://blogzine.webestica.com/post-single-4.html"
                                                                    class="btn-link text-reset fw-normal">Initial
                                                                    problem of startups and their solution</a></h2>
                                                            <p class="text-white"> Thirty it matter enable become admire
                                                                in giving. See resolved goodness felicity shy civility
                                                                domestic. </p>
                                                            <!-- Card info -->
                                                            <ul
                                                                    ...
                                                                    <div class="nav-link">
                                                                        <div
                                                                            ...
                                                                            <span class="ms-3">by <a
                                                                                    href="https://blogzine.webestica.com/index-2.html#"
                                        ...
                                        <!-- Slide item -->
                                        <div class="card bg-dark-overlay-3 rounded-0 h-400 h-lg-500 h-xl-700 position-relative overflow-hidden tns-item tns-slide-active"
                                            style="background-image:url(assets/images/blog/16by9/big/02.jpg); background-position: center left; background-size: cover;"
                                            id="tns1-item0">
                                            <!-- Card Image overlay -->
                                            <div class="card-img-overlay rounded-0 d-flex align-items-center">
                                                <div class="container px-3 my-auto">
                                                    <div class="row">
                                                        <div class="col-lg-7">
                                                            ...
                                                            <h2 class="text-white display-5"><a
                                                                    href="https://blogzine.webestica.com/post-single-4.html"
                                                                    class="btn-link text-reset fw-normal">10 tell-tale
                                                                    signs you need to get a new startup.</a></h2>
                                                            <p class="text-white">No visited raising gravity outward
                                                                subject my cottage Mr be. Hold do at tore in park feet
                                                                near my case. </p>
                                                            <!-- Card info -->
                                                            <ul
                                                                class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                        ...
                        <div class="col-xl-4 custom-thumb pe-5 position-absolute top-50 end-0 translate-middle-y d-none d-xxl-block"
                            id="custom-thumb" aria-label="Carousel Pagination">
                            <!-- Thumb 1 -->
                            <div class="row align-items-center g-3 mb-4 tns-nav-active" data-nav="0"
                                aria-label="Carousel Page 1 (Current Slide)" aria-controls="tns1">
                                <div class="col-auto">
                                    <div class="avatar avatar-lg">
                                        <img class="avatar-img rounded-circle"
                                            src="blogzine/02(1).jpg"
                                            alt="avatar">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <h4 class="fw-normal text-truncate mb-1">Tell-tale signs you need to get a new
                                        startup</h4>
                            ...
                            <!-- Thumb 2 -->
                            <div class="row align-items-center g-3 mb-4" data-nav="1" tabindex="-1"
                                aria-label="Carousel Page 2" aria-controls="tns1">
                                <div class="col-auto">
                                    <div class="avatar avatar-lg">
                                        <img class="avatar-img rounded-circle"
                                            src="blogzine/01(1).jpg"
                                            alt="avatar">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <h4 class="fw-normal text-truncate mb-1">7 common mistakes everyone makes while
                                        traveling</h4>
                                    <p class="text-truncate d-block col-11 small mb-0">Particular way thoroughly
                                        unaffected projection favorable </p>
                                </div>
                            </div>
                            <!-- Thumb 3 -->
                            <div class="row align-items-center g-3" data-nav="2" tabindex="-1"
                                aria-label="Carousel Page 3" aria-controls="tns1">
                                <div class="col-auto">
                                    <div class="avatar avatar-lg">
                                        <img class="avatar-img rounded-circle"
                                            src="blogzine/03(1).jpg"
                                            alt="avatar">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <h4 class="fw-normal text-truncate mb-1">Initial problem of startups and their
                                        solution</h4>
                                    <p class="text-truncate d-block col-11 small mb-0">Drawings offended yet answered
                                        Jennings perceive</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tiny-slider arrow-hover arrow-blur arrow-dark arrow-round mt-3">
                        <div class="tns-outer" id="tns2-ow">
                            <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">
                                slide <span class="current">15 to 18</span> of 5</div>
                            <div id="tns2-mw" class="tns-ovh">
                                <div class="tns-inner" id="tns2-iw">
                                    <div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                        ...
                                        data-items-md="3" data-items-sm="2" data-items-xs="1" id="tns2"
                                        ...
                                        <div class="card tns-item tns-slide-cloned" aria-hidden="true"
                                            ...
                                            <div class="card-body px-0 pt-3">
                                                <h5 class="card-title"><a
                                                        href="https://blogzine.webestica.com/post-single-6.html"
                                                        class="btn-link text-reset fw-bold">10 tell-tale signs you need
                                                        to get a new business</a></h5>
                                                <!-- Card info -->
                                        ...
                                        <div class="card tns-item tns-slide-cloned" aria-hidden="true"
                                            ...
                                            <div class="card-body px-0 pt-3">
                                                <h5 class="card-title"><a
                                                        href="https://blogzine.webestica.com/post-single-6.html"
                                                        class="btn-link text-reset fw-bold">This is why this year will
                                                        be the year of startups</a></h5>
                                                <!-- Card info -->
                                                <ul class="nav nav-divider align-items-center">
                                                    <li class="nav-item">
                                                        <div class="nav-link">
                                        ...
                                        <div class="card tns-item tns-slide-cloned" aria-hidden="true"
                                            ...
                                            <div class="position-relative">
                                                <img class="card-img"
                                                    src="blogzine/11(1).jpg"
                                                    alt="Card image">
                                                <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                                    <!-- Card overlay bottom -->
                                                    <div class="w-100 mt-auto">
                                                        <a href="https://blogzine.webestica.com/index-2.html#"
                                                            class="badge text-bg-warning mb-2"><i
                                            ...
                                            <div class="card-body px-0 pt-3">
                                                <h5 class="card-title"><a
                                                        href="https://blogzine.webestica.com/post-single-6.html"
                                                        class="btn-link text-reset fw-bold">Best Pinterest Boards for
                                                        learning about business</a></h5>
                                                <!-- Card info -->
                                                <ul class="nav nav-divider align-items-center">
                                                    <li class="nav-item">
                                                        <div class="nav-link">
                                        ...
                                        <div class="card tns-item tns-slide-cloned" aria-hidden="true"
                                            ...
                                            <div class="card-body px-0 pt-3">
                                                <h5 class="card-title"><a
                                                        href="https://blogzine.webestica.com/post-single-6.html"
                                                        class="btn-link text-reset fw-bold">7 common mistakes everyone
                                                        makes while traveling</a></h5>
                                                <!-- Card info -->
                                                <ul class="nav nav-divider align-items-center">
                                                    <li class="nav-item">
                                                        <div class="nav-link">
                                        ...
                                        <div class="card tns-item tns-slide-cloned" aria-hidden="true"
                                            ...
                                            <div class="card-body px-0 pt-3">
                                                <h5 class="card-title"><a
                                                        href="https://blogzine.webestica.com/post-single-6.html"
                                                        class="btn-link text-reset fw-bold">Skills that you can learn
                                                        from business</a></h5>
                                                <!-- Card info -->
                                                <ul class="nav nav-divider align-items-center">
                                                    <li class="nav-item">
                                        ...
                                        <!-- Card item START -->
                                        <div class="card tns-item" id="tns2-item0" aria-hidden="true"
                                            tabindex="-1">
                                            <!-- Card img -->
                                            <div class="position-relative">
                                                <img class="card-img"
                                        ...
                                        <!-- Card item END -->
                                        <!-- Card item START -->
                                        <div class="card tns-item" id="tns2-item1" aria-hidden="true"
                                            tabindex="-1">
                                            <!-- Card img -->
                                            <div class="position-relative">
                                                <img class="card-img"
                                        ...
                                        <!-- Card item END -->
                                        <!-- Card item START -->
                                        <div class="card tns-item" id="tns2-item2" aria-hidden="true"
                                            tabindex="-1">
                                            <!-- Card img -->
                                            <div class="position-relative">
                                                <img class="card-img"
                                        ...
                                        <!-- Card item END -->
                                        <!-- Card item START -->
                                        <div class="card tns-item" id="tns2-item3" aria-hidden="true"
                                            tabindex="-1">
                                            <!-- Card img -->
                                            <div class="position-relative">
                                                <img class="card-img"
                                        ...
                                        <!-- Card item END -->
                                        <!-- Card item START -->
                                        <div class="card tns-item" id="tns2-item4" aria-hidden="true"
                                            tabindex="-1">
                                            <!-- Card img -->
                                            <div class="position-relative">
                                                <img class="card-img"
                                ...
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-5">
                                    <div class="w-100 mt-auto">
                                        <div class="col">
                                            ...
                                            <a href="https://blogzine.webestica.com/index-2.html#!"
                                                class="badge mb-2 bg-dark z-index-99 position-relative" tabindex="0"
                                                role="button" data-bs-container="body" data-bs-toggle="popover"
                                            ...
                                            <!-- Card title -->
                                            <h2 class="text-white display-6"><a
                                                    href="https://blogzine.webestica.com/post-single-5.html"
                        ...
                        <div class="col-lg-5">
                                    ...
                                    <div class="col-8">
                                        <a href="https://blogzine.webestica.com/index-2.html#"
                                            class="badge bg-danger bg-opacity-10 text-danger mb-2"><i
                                                class="fas fa-circle me-2 small fw-bold"></i>Lifestyle</a>
                                        <h5><a href="https://blogzine.webestica.com/post-single-5.html"
                            ...
                            <div class="card mb-2 mb-md-4">
                                <div class="row g-3">
                                    <div class="col-4">
                                        <img class="rounded-3"
                                            src="blogzine/02(2).jpg"
                                            alt="">
                                    </div>
                                    <div class="col-8">
                                        <a href="https://blogzine.webestica.com/index-2.html#"
                                            class="badge bg-info bg-opacity-10 text-info mb-2"><i
                                                class="fas fa-circle me-2 small fw-bold"></i>Sports</a>
                                        <h5><a href="https://blogzine.webestica.com/post-single-5.html"
                            ...
                            <div class="card mb-2 mb-md-4">
                                <div class="row g-3">
                                    <div class="col-4">
                                        <img class="rounded-3"
                                            src="blogzine/03(2).jpg"
                                            alt="">
                                    </div>
                                    <div class="col-8">
                                        <a href="https://blogzine.webestica.com/index-2.html#"
                                            class="badge bg-success bg-opacity-10 text-success mb-2"><i
                                                class="fas fa-circle me-2 small fw-bold"></i>Business</a>
                                        <h5><a href="https://blogzine.webestica.com/post-single-5.html"
                            ...
                            <div class="card mb-2 mb-md-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-8">
                                        <a href="https://blogzine.webestica.com/index-2.html#"
                                            class="badge bg-warning bg-opacity-15 text-warning mb-2"><i
                                                class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                                        <h5><a href="https://blogzine.webestica.com/post-single-5.html"
            ...
            <div class="row g-0">
                <div class="col-12 bg-light p-2 p-sm-4 rounded-3">
                    ...
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="https://blogzine.webestica.com/index-2.html#"
                            class="text-body text-primary-hover"><u>View all categories</u></a>
                    </div>
                    <!-- Slider -->
                    <div class="tiny-slider arrow-hover arrow-dark arrow-blur arrow-round">
                        <div class="tns-outer" id="tns3-ow">
                            <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">
                                slide <span class="current">9 to 13</span> of 5</div>
                            <div id="tns3-mw" class="tns-ovh">
                                <div class="tns-inner" id="tns3-iw">
                                    <div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                        ...
                                        data-items-md="3" data-items-sm="2" data-items-xs="2" id="tns3"
                                        style="transition-duration: 0s; transform: translate3d(-38.0952%, 0px, 0px);">
                                        <div class="tns-item tns-slide-cloned tns-transparent" aria-hidden="true"
                                            tabindex="-1">
                                            <div class="card card-overlay-bottom card-img-scale">
                                                <img class="card-img"
                                                    src="blogzine/03(4).jpg"
                                                    alt="card image">
                            ...
                            <div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"
                                style="display: none;"><button type="button" data-controls="prev"
                                    tabindex="-1" aria-controls="tns3"><i
                                        class="fas fa-chevron-left"></i></button><button type="button"
                                    data-controls="next" tabindex="-1" aria-controls="tns3"><i
                                        class="fas fa-chevron-right"></i></button></div>
                        </div>
                    </div> <!-- Slider END -->
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    ...
                    <p class="m-0">Get the latest sports news and updates from football, tennis, formula one,
                        cricket, NBA, and golf with live scores and stats</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-4 mb-md-0">
                    ...
                    <div class="card card-overlay-bottom card-bg-scale h-300 h-lg-540"
                        style="background-image:url(assets/images/blog/16by9/06.jpg); background-position: center left; background-size: cover;">
                        <!-- Card Image overlay -->
                        <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                            <div class="w-100 mt-auto">
                                <div class="col">
                                    ...
                                    <h2 class="text-white display-6"><a
                                            href="https://blogzine.webestica.com/post-single-4.html"
                                            class="btn-link text-reset stretched-link fw-normal">8 initial problem of
                                            startups and their solution</a></h2>
                                    <!-- Card info -->
                                    <ul
                                        class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                ...
                <div class="col-md-6">
                    <!-- Card item START -->
                    <div class="card card-overlay-bottom card-bg-scale h-300 h-lg-540"
                        style="background-image:url(assets/images/blog/16by9/01.jpg); background-position: center left; background-size: cover;">
                        <!-- Card Image overlay -->
                        <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                            <div class="w-100 mt-auto">
                                <div class="col">
                                    ...
                                    <h2 class="text-white display-6"><a
                                            href="https://blogzine.webestica.com/post-single-4.html"
                                            class="btn-link text-reset stretched-link fw-normal">Business ideas that
                                            will boom in upcoming years</a></h2>
                                    <!-- Card info -->
                                    <ul
                                        class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mb-4 d-md-flex justify-content-between align-items-center">
                        ...
                        <a href="https://blogzine.webestica.com/index-2.html#" class="text-body small"><u>Content
                                by: Bootstrap</u></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-8">
                                <a href="https://blogzine.webestica.com/index-2.html#"
                                    class="badge bg-danger bg-opacity-10 text-danger mb-2"><i
                                        class="fas fa-circle me-2 small fw-bold"></i>Lifestyle</a>
                                <h4><a href="https://blogzine.webestica.com/post-single-5.html"
                                        class="btn-link stretched-link text-reset fw-bold">The pros and cons of
                                        business agency</a></h4>
                                <!-- Card info -->
                                <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                    <li class="nav-item">
                                        <div class="nav-link">
                            ...
                            <div class="col-8">
                                <a href="https://blogzine.webestica.com/index-2.html#"
                                    class="badge bg-info bg-opacity-10 text-info mb-2"><i
                                        class="fas fa-circle me-2 small fw-bold"></i>Sports</a>
                                <h4><a href="https://blogzine.webestica.com/post-single-5.html"
                                        class="btn-link stretched-link text-reset fw-bold">5 reasons why you shouldn't
                                        startup</a></h4>
                                <!-- Card info -->
                                <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                    <li class="nav-item">
                            ...
                            <div class="col-8">
                                <a href="https://blogzine.webestica.com/index-2.html#"
                                    class="badge bg-success bg-opacity-10 text-success mb-2"><i
                                        class="fas fa-circle me-2 small fw-bold"></i>Business</a>
                                <h4><a href="https://blogzine.webestica.com/post-single-5.html"
                                        class="btn-link stretched-link text-reset fw-bold">Five unbelievable facts
                                        about money.</a></h4>
                                <!-- Card info -->
                                <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                    <li class="nav-item">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-8">
                                <a href="https://blogzine.webestica.com/index-2.html#"
                                    class="badge bg-warning bg-opacity-15 text-warning mb-2"><i
                                        class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                                <h4><a href="https://blogzine.webestica.com/post-single-2.html"
                                        class="btn-link stretched-link text-reset fw-bold">Around the web: 20 fabulous
                    ...
                    <div class="card mb-3 mb-sm-4">
                        <div class="row g-3">
                            <div class="col-4">
                                <img class="rounded-3"
                                    src="blogzine/05(2).jpg"
                                    alt="">
                            </div>
                            <div class="col-8">
                                <a href="https://blogzine.webestica.com/index-2.html#"
                                    class="badge bg-primary bg-opacity-10 text-primary mb-2"><i
                                        class="fas fa-circle me-2 small fw-bold"></i>Marketing</a>
                                <h4><a href="https://blogzine.webestica.com/post-single-6.html"
                                        class="btn-link stretched-link text-reset fw-bold">7 common mistakes everyone
                                        makes while traveling</a></h4>
                                <!-- Card info -->
                                <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                    <li class="nav-item">
                                        <div class="nav-link">
                            ...
                            <div class="col-8">
                                <a href="https://blogzine.webestica.com/index-2.html#"
                                    class="badge bg-danger bg-opacity-10 text-danger mb-2"><i
                                        class="fas fa-circle me-2 small fw-bold"></i>Photography</a>
                                <h4><a href="https://blogzine.webestica.com/post-single-5.html"
                                        class="btn-link stretched-link text-reset fw-bold">5 investment doubts you
                                        should clarify</a></h4>
                                <!-- Card info -->
                                <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                    <li class="nav-item">
                            ...
                            <div class="col-md-8 col-lg-6 mx-auto text-center py-5 position-relative">
                                ...
                                <form class="row row-cols-sm-auto g-2 align-items-center justify-content-center mt-3">
                                    ...
                                    <div class="form-text text-white opacity-6 mt-2">By subscribing you agree to our
                                        <a href="https://blogzine.webestica.com/index-2.html#"
                                            class="text-decoration-underline text-reset">Privacy Policy</a>
                                    </div>
                                </form>
                            </div>
                        </div>
